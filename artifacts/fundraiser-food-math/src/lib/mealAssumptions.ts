...
export const breakfastBurritoAssumptions: MealAssumption = {
  ...
  ingredients: [
    ...
    {
      name: "O'Brien Potatoes (20 oz bag)",
      perServing: 0.158,
      unit: "lb",
      packageSize: 1.25,
      packageUnit: "20 oz bag",
