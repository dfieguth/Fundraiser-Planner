...
export const hotDogAssumptions: MealAssumption = {
  ...
  supplies: [
    { name: "Paper Plates (9\")", perPerson: 1.0, packageSize: 100, costPerPackage: [5.00, 9.00] },
    { name: "Napkins", perPerson: 1.5, packageSize: 250, costPerPackage: [3.50, 6.00] },
    { name: "Plastic Forks & Knives", perPerson: 1.0, packageSize: 100, costPerPackage: [4.00, 7.00] },
...
export const burgerAssumptions: MealAssumption = {
  ...
  supplies: [
    { name: "Sturdy Paper Plates (10\")", perPerson: 1.0, packageSize: 100, costPerPackage: [7.00, 13.00] },
    { name: "Napkins", perPerson: 1.5, packageSize: 250, costPerPackage: [3.50, 6.00] },
    { name: "Plastic Forks & Knives", perPerson: 1.0, packageSize: 100, costPerPackage: [4.00, 7.00] },
...
export const breakfastBurritoAssumptions: MealAssumption = {
  ...
  supplies: [
    ...
    { name: "Paper Plates", perPerson: 1.0, packageSize: 100, costPerPackage: [5.00, 9.00] },
    { name: "Napkins", perPerson: 1.5, packageSize: 250, costPerPackage: [3.50, 6.00] },
    { name: "Plastic Forks", perPerson: 1.0, packageSize: 100, costPerPackage: [3.50, 6.00] },
    { name: "Disposable Gloves (box of 100)", perPerson: 0.03, packageSize: 100, costPerPackage: [9.00, 16.00] },
...
export const tacoAssumptions: MealAssumption = {
  ...
  supplies: [
    { name: "Paper Plates (9\" or 10\")", perPerson: 1.0, packageSize: 100, costPerPackage: [5.00, 9.00] },
    { name: "Napkins", perPerson: 1.5, packageSize: 250, costPerPackage: [3.50, 6.00] },
    { name: "Plastic Forks", perPerson: 1.0, packageSize: 100, costPerPackage: [3.50, 6.00] },
...
export const spaghettiAssumptions: MealAssumption = {
  ...
  supplies: [
    { name: "Foam or Paper Bowls (12 oz) for pasta", perPerson: 1.0, packageSize: 50, costPerPackage: [6.00, 11.00] },
    { name: "Paper Plates (for garlic bread & salad)", perPerson: 1.0, packageSize: 100, costPerPackage: [5.00, 9.00] },
    { name: "Plastic Forks (2 per guest: pasta + salad)", perPerson: 2.0, packageSize: 100, costPerPackage: [3.50, 6.00] },
    { name: "Napkins", perPerson: 1.5, packageSize: 250, costPerPackage: [3.50, 6.00] },
...
export const pancakeAssumptions: MealAssumption = {
  ...
  supplies: [
    { name: "Paper Plates (10\")", perPerson: 1.0, packageSize: 100, costPerPackage: [5.00, 9.00] },
    { name: "Plastic Forks", perPerson: 1.0, packageSize: 100, costPerPackage: [3.50, 6.00] },
    { name: "Napkins", perPerson: 1.5, packageSize: 250, costPerPackage: [3.50, 6.00] },
...
export const walkingTacosAssumptions: MealAssumption = {
  ...
  supplies: [
    { name: "Plastic Forks (one per person — no plates needed!)", perPerson: 1.0, packageSize: 100, costPerPackage: [3.50, 6.00] },
    { name: "Napkins", perPerson: 1.5, packageSize: 250, costPerPackage: [3.50, 6.00] },
    { name: "Aluminum Foil Pans (for holding seasoned meat)", perPerson: 0.02, packageSize: 5, costPerPackage: [7.00, 12.00] },
...
export const customAssumptions: MealAssumption = {
  ...
  supplies: [
    { name: "Paper Plates (9\" or 10\")", perPerson: 1.0, packageSize: 100, costPerPackage: [5.00, 9.00] },
    { name: "Plastic Utensils (fork, knife, spoon combo pack)", perPerson: 1.0, packageSize: 100, costPerPackage: [4.50, 8.00] },
    { name: "Napkins", perPerson: 1.5, packageSize: 250, costPerPackage: [3.50, 6.00] },
    { name: "Trash Bags (13-gallon)", perPerson: 0.03, packageSize: 30, costPerPackage: [9.00, 17.00] },
    { name: "Disposable Gloves (box of 100)", perPerson: 0.02, packageSize: 100, costPerPackage: [9.00, 16.00] },
  ],
